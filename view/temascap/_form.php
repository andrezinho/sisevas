...
<form id="frm_temas" >
    <input type="hidden" name="controller" value="temascap" />
    <input type="hidden" name="action" value="save" />   
    <input type="hidden" id="idtemas" name="idtemas" value="<?php echo $obj->idtemas; ?>" />    
    <label for="idcompetencia" class="labels">Linea de Accion:</label>
    <?php echo $lineas; ?>
    <br/>
