<script type="text/javascript">
    ...
    function consultar(tp)
    {
        ...
        $.get('index.php','controller=reportes&action=data_rep08&tipo=consultar&anio='+anioc+'&tp='+tp,function(r){
    ...
    function pdf(tp)
    {
        ...
        {
            var anioc = $("#anioc"+tp).val();
            window.open('index.php?controller=reportes&action=data_rep08&tipo=pdf&anio='+anioc+'&tp='+tp, "Reporte");
        }
    }
...
<div class="div_container">
    <h6 class="ui-widget-header ui-state-hover">Reporte: Por Cat. de Presupuesto</h6>
        ...
        <form name="frm" id="frm" action="" method="get">
            ...
            <section class="ac-container">
                <div>
					...
					<label for="ac-1">Objetivos de Capaciotaci&oacute;n / Cat. de Presupuesto</label>
				...
				<div>
					...
					<label for="ac-2">Eje de Capacitaci&oacute;n / Cat. de Presupuesto</label>
					<article class="ac-large">
                    	<br/><br/>
                        <span>Seleccione el A&ntilde;o:</span>    
                        <?php
                ...
                <div>
					...
					<label for="ac-3">Personal / Cat. de Presupuesto</label>
					<article class="ac-large">
						<br/><br/>
                        <span>Seleccione el A&ntilde;o:</span>    
                        <?php
				...
				<div>
					...
					<label for="ac-4">Objetivos de la empresa / Cat. de Presupuesto</label>
					<article class="ac-large">
						<br/><br/>
                        <span>Seleccione el A&ntilde;o:</span>    
                        <?php
                ...
                <div>
					...
					<label for="ac-5">lineas de Accion / Cat. de Presupuesto</label>
					<article class="ac-large">
						<br/><br/>
                        <span>Seleccione el A&ntilde;o:</span>    
                        <?php
