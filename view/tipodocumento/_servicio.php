    ...
    <div id="tabs">
        ...
        <div id="tabs-1">
            ...
            <fieldset>
                ...
                <input type="hidden" id="fechainicio" name="fechainicio"  value="<?php if ($obj->fechainicio == '') echo date('d/m/Y'); else echo fdate($obj->fechainicio, 'ES'); ?>" />
                <input type="hidden" id="horainicio" name="horainicio"  value="<?php if ($obj->horainicio == '') echo date('H:i:s'); else echo $obj->horainicio; ?>" />
                <br />
        ...
        <div id="tabs-2">
            ...
            <fieldset class="fieldset">
                <legend class="legend">Descripción del problema</legend>
                <textarea name="problema" id="problema" style="width: 95%; margin-left: 20px;" class="text ui-widget-content ui-corner-all" cols="30" rows="10" ></textarea>
                <br />
            ...
            <fieldset class="fieldset">
                <legend class="legend">Los Involucrados en el problema:</legend>
