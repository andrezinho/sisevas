<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#consultar").click(function ()
        {
            if (valid())
            {
                ...
                $.get('index.php','controller=Consultas&action=data_informe&tipo=consultar&'+str,function(r){
    ...
    function valid()
    {
        ...
        bval = bval && $("#personal_name").required();
        return bval;
    }
...
<div class="div_container">
    <h6 class="ui-widget-header ui-state-hover">Reporte: Informe Memoria</h6>
