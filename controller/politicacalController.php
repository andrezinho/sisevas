...
require_once '../model/politicacal.php';

class politicacalController extends Controller
{
    var $cols = array(
                        1 => array('Name'=>'Codigo','NameDB'=>'idpolitica_calidad','align'=>'center','width'=>'20'),
    ...
    public function index() 
    {
		...
		$data['titulo'] = "Politicas de Calidad";
    ...
    public function create()
    {
        ...
        $view = new View();        
        $view->setData($data);
        $view->setTemplate( '../view/politicacal/_form.php' );
