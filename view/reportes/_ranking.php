...
$(document).ready(function(){
    ...
    */
    $("#pdf").click(function()
    {
        ...
        {
            var str = $("#frm").serialize();
            window.open('index.php?controller=reportes&action=data_rankingeva&tipo=pdf&'+str,"Reporte");
        }
    });
});
function valid()
...
<h6 class="ui-widget-header ui-state-hover">Reporte: Ranking de Evaluacion</h6>
