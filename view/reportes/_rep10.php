<script type="text/javascript">
    ...
    function consultar(tp)
    {
        ...
        $.get('index.php', 'controller=reportes&action=data_rep10&tipo=consultar&anio=' + anioc + '&tp=' + tp, function (r) {
    ...
    function pdf(tp)
    {
        ...
        {
            var anioc = $("#anioc" + tp).val();
            window.open('index.php?controller=reportes&action=data_rep10&tipo=pdf&anio=' + anioc + '&tp=' + tp, "Reporte");
        }
    }
...
<div class="div_container">
    <h6 class="ui-widget-header ui-state-hover">Reporte: Por Lineas de Accion</h6>
        ...
        <form name="frm" id="frm" action="" method="get">
            ...
            <section class="ac-container">
                <div>
                    ...
                    <label for="ac-1">Lineas de Acci&oacute;n / Objetivos de la empresa </label>
                ...
                <div>
                    ...
                    <label for="ac-2">Lineas de Acci&oacute;n / Objetivos de la capacitaci&oacute;n</label>
                    <article class="ac-large">
                        <br/><br/>
                        <span>Seleccione el A&ntilde;o:</span>    
                        <?php
                ...
                <div>
                    ...
                    <label for="ac-3">Lineas de Acci&oacute;n / Tiempo de Dedicaci&oacute;n</label>
                    <article class="ac-large">
                        <br/><br/>
                        <span>Seleccione el A&ntilde;o:</span>    
                        <?php
