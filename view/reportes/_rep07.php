<script type="text/javascript">
    ...
    function consultar(tp)
    {
        ...
        $.get('index.php', 'controller=reportes&action=data_rep07&tipo=consultar&anio=' + anioc + '&tp=' + tp, function (r) {
    ...
    function pdf(tp)
    {
        ...
        {
            var anioc = $("#anioc" + tp).val();
            window.open('index.php?controller=reportes&action=data_rep07&tipo=pdf&anio=' + anioc + '&tp=' + tp, "Reporte");
        }
    }
...
<div class="div_container">
    <h6 class="ui-widget-header ui-state-hover">Reporte: Por Tipo de Alcance</h6>
        ...
        <form name="frm" id="frm" action="" method="get">
            ...
            <section class="ac-container">
                <div>
                    ...
                    <label for="ac-1">Objetivos de Capaciotaci&oacute;n / Tipo Alcance</label>
                ...
                <div>
                    ...
                    <label for="ac-2">Tiempo de Dedicaci&oacute;n / Tipo Alcance</label>
                    <article class="ac-large">
                        <br/><br/>
                        <span>Seleccione el A&ntilde;o:</span>    
                        <?php
                ...
                <div>
                    ...
                    <label for="ac-5">Lineas de Acci&oacute;n / Tipo Alcance</label>
                    <article class="ac-large">
                        <br/><br/>
                        <span>Seleccione el A&ntilde;o:</span>    
                        <?php
