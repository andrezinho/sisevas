    ...
    *******************************************************************************/
    function FPDF($orientation='P', $unit='mm', $format='A4')
    {
    	...
    	$this->PageFormats=array('a3'=>array(841.89,1190.55), 'a4'=>array(595.28,841.89), 'a5'=>array(420.94,595.28),
    		'letter'=>array(612,792), 'legal'=>array(612,1008),'b1'=>array(510.24,430.87));
    	if(is_string($format))
    ...
    function nLineaBreak($w, $h, $txt, $align='J')
    {
        $my_c=1;
    ...
    function MultiCellp($w, $h, $txt, $border=0, $align='J', $fill=false)
    {
    	//Output text with automatic or explicit line breaks
    	$this->originaly=$this->y;
    	$cw=&$this->CurrentFont['cw'];
    ...
    *******************************************************************************/
    ...
    function Row($data)
    {
    	...
    	for($i=0;$i<count($data);$i++)
    	{
    		...
    		$this->MultiCell($w,4,$data[$i],'RML',$a,$fill);
    		$this->SetXY($x+$w,$y);
    	}
    	$this->Ln($h);
    ...
    function fechaALetras($fecha){
        ...
        $dia= strtolower($this->numtoletras($fecha_separada[0]));
        ...
        $anio= strtolower($this->numtoletras($fecha_separada[2]));       
